...
<div class="wrapper-head-chef">
    <div class=head-chef>
        <div class="left-side">
            <a href="#"><img src="<?php echo base_url('assets/upload/image/thumbs/'.$user['avatar']) ?>" alt="head chef"/></a>
        </div>
        <div class="right-side">
            <h3><a href="#"><?php echo $user['nama'];?></a></h3>
            <span class="type"><?php echo $user['nama'];?></span>
            <ul class="expertise">
                <li><a href="#"><svg version="1.1" class="icon-container" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
