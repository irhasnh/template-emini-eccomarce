...
<div class="col-md-12">
    <h2><img src="<?php echo base_url('assets/upload/image/thumbs/'.$site['logo']) ?>"></h2>
</div>
</div>
<div class="row ">
...
<div class="alert alert-warning"><?php echo $this->session->flashdata('sukses') ?></div>
<?php } ?>
...
<div class="form-group">
    ...
    <input type="reset" name="reset" value="Reset" class="btn btn-default"> 
     <span class="pull-left">
       <a href="<?php echo base_url('login/forget') ?>" title="Forget password">Forget password ? </a> | 
       <a href="<?php echo base_url() ?>" title="Back to homepage">Back to homepage</a>
     </span>
</form>
</div>
</div>
