...
<form action="<?php echo base_url('admin/user/create') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-12">
	<div class="form-group">
    	<label>BIO</label>
        <textarea name="bio" placeholder="BIO" class="form-control" id="bio"><?php echo set_value('bio') ?></textarea>
    </div>
