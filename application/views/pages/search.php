...
<div class="listing">
    ...
    <div class="detail">
        <h4><a href="#"><?php echo $berita['nama_toko'];?></a></h4>
        <p><?php echo  substr (strip_tags($berita['info_toko']),0,150);?></p>
        <div class="meta-listing">
            <ul class="post-meta">
                <li class="author"><?php echo $berita['nama_toko'];?></li>
            </ul>
            <a class="read-more-bordered" href="<?php echo base_url('store/read/'.$berita['slug_store']) ?>">Read More</a>
        </div>
    </div>
</div>
<?php } ?>
